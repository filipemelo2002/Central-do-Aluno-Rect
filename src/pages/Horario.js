...
export default function Horario() {
  ...
  const displayLoading = useMemo(()=>horario.length===0?'flex':'none',[horario])
  const displayHorario = useMemo(()=>horario.length===0?'none':'flex',[horario])
  ...
  <SafeAreaView style={styles.container}>
      <Lottie
        ...
        loop
      />
    <View style={{flex:1, alignItems:"center", justifyContent:"center", display:displayHorario}}>
      <FlatList
        horizontal
